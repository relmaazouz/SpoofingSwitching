...
public class PhysicaAFrenchTax extends ModerateAgent{
	...
	public PhysicaAFrenchTax(String name,long cash, long InitialPrice, 
...
//===Flash Crash==============================		
		...
		if(dir==LimitOrder.BID) {//Traitons d'abord le cas d'achat
			...
			this.Wealth.add(price*(this.getInvest(obName)+1)+this.cash-price*(1+tax));
